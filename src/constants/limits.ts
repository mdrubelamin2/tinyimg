...
export const LARGE_IMAGE_SERIAL_THRESHOLD_PIXELS = 24_000_000
...
export const CONCURRENCY_MAX_DESKTOP = Math.max(
  1,
...
export const RESIZE_MAX_EDGE_MAX = 16_384
...
export const SVG_RASTER_BYTES_MAX = 32_768 // 32 KB
