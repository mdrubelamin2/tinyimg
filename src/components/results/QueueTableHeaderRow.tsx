export function QueueTableHeaderRow() {
  return (
    <div className="grid grid-cols-[25%_15%_40%_20%] w-full">
      <div className="p-2 text-left align-middle font-bold md:px-6 lg:px-8 md:py-4">
        File Name
      </div>
      ...
      <div className="p-2 text-left align-middle min-w-0 font-bold md:px-6 md:py-4">
        Status &amp; Formats
      </div>
