  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 disabled:pointer-events-none disabled:opacity-50 cursor-pointer active:scale-[0.98]',
  {
    ...
    variants: {
      ...
      variant: {
        ...
        destructive:
          'bg-destructive text-destructive-foreground hover:opacity-90 shadow-lg shadow-destructive/25 transition-colors duration-200',
        ghost:
          'text-muted-foreground hover:bg-muted hover:text-foreground transition-colors duration-200',
        secondary:
          'border border-border bg-surface text-surface-foreground hover:bg-muted hover:border-primary/30 transition-colors duration-200',
      },
    },
  },
)
